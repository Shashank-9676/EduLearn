...
//   })
//     user.org_name = await db.execute(`SELECT name FROM organizations WHERE id = ?`, [user.organization_id])
...
export const login = async (req, res) => {
  try {
    ...
    // This part of your original code had a syntax error. It should also use the object syntax.
